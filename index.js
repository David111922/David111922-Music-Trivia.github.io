...
const questions = [
  {
    question:
      "The songs 'Red Skies' and 'Saved by Zero' were huge hits for which 80's band?",
  ...
  {
    question:
      "Always the artistic innovator. Whose alter-ego was known as 'Ziggy Stardust'?",
  ...
  {
    question:
      "One of the all-time greats. Who was the original guitarists for Led Zeppellin?",
  ...
  {
    question:
      'His music will live on forever. Who wrote the song "I Shot the Sheriff"?',
  ...
  {
    question:
      "'Should I Stay or Should I Go' was a huge hit for which British band?",
    options: [
      "The Ramones",
      "Velvet Underground",
      "The Sex Pistols",
  ...
  {
    question:
      '"Sweetest Tabboo" and "Smooth Operator" were huge hits for which singer?',
  ...
  {
    question:
      'At the age of 17 he played with Dizzy Gilespie. Who wrote the jazz standard "So What"?',
    options: [
      "John Coltrane",
      "Wes Montgomery",
      "Thelonius Monk",
  ...
  {
    question:
      'Hits like "Quimbare" among many. Who was crowned the "Queen of Salsa"?',
  ...
  {
    question:
      'Which band wrote and performed the hit theme song for the show "Bad Boys"?',
  ...
  {
    question:
      '"Birdland" was a huge hit for this jazz Giant in 1971 and has been covered by many others.',
    options: [
      "Charlie Parker",
      "Glen Miller",
      "Tower of Power",
  ...
  {
    question:
      "'Jailbreak' was a huge hit in the 70's. Who was the original front man for the band Thin Lizzy?",
  ...
  {
    question:
      "Which singer was known as'Ol' Blue Eyes' and 'The Chairman of the Board'?",
    options: [
      "Frank Sinatra",
      "David Coverdale",
      "Andy Williams",
  ...
  {
    question:
      "'Moonglow' and 'Let's Dance' were big hits in the 1930's for this band leader?",
  ...
  {
    question:
      'The song "Breezin" was a huge hit for this great guitarist and vocalist.',
    options: [
      "Eddie Van Halen",
      "Mateo Mancusso",
      "Carlos Santana",
  ...
  {
    question:
      "A huge part of the British Invasion. What year did the Beatles play on Ed Sullivan?",
  ...
  {
    question:
      "Possibly know better for his solo career. Who was the original singer for Genesis?",
  ...
  {
    question:
      "Maybe the greatest rock guitar solo ever. Who was the guitarist on 'Eruption'?",
  ...
  {
    question:
      "The song,'Bamboleo' went mainstream for this Rumba Flamenca band?",
    options: [
      "Los Del Rio",
      "Gypsy Kings",
      "Gente De Zona",
  ...
  {
    question:
      "Arguably the best Flamenco guitarist ever he wrote and played the song 'Entre Dos Aguas'.",
  ...
  {
    question:
      "Lynard Skynard had many hits during his career, but this was not one of them.",
    options: [
      "Sweet Home Alabama",
      "Mississippi Queen",
      "Tuesday's Gone",
  ...
  {
    question:
      "The orangutan in the Jungle Book sings 'I wanna be like you'. Who is the voice behind the primate?",
  ...
  {
    question:
      "In what year was the Pink Floyd album 'Dark Side of the Moon' released?",
  ...
  {
    question:
      "This duo had numerous hits. A true musical icon. Who was Garfunkel's singing partner?",
  ...
  {
    question:
      "Geddy Lee was the original bassist and lead singer of which famous rock band?",
  ...
  {
    question:
      "In this famous song by Eddie Money, how many tickets does he have to Paradise?",
    options: ["1", "8", "2", "3"],
    answer: "2",
  ...
  {
    question:
      "Who is Jane 'through with' in this 1988 hit about drug abuse by Jane's Addiction?",
  ...
  {
    question:
      "In 1974, Led Zeppelin decided to launch their own record label. What was its name?",
  ...
  {
    question:
      "This all female rock band had a big hit with the song 'What's Up'. What is the name of this band?",
  ...
  {
    question:
      "Which American rock  band released 'Hard to Handle' along with 'Remedy' in 1990?",
    options: [
      "Nirvana",
  ...
  {
    question:
      "One of the great rock voices from the early 90's. Who is the lead singer for Pearl Jam?",
  ...
  {
    question:
      "He was a huge part of this band's unique sound. Who was the drummer for The Police?",
  ...
  {
    question:
      "'Reasons' and 'Shining Star' were huge hits for this band in the mid 1970's?",
    options: [
      "Parliament",
      "Kool and the Gang",
      "Earth, Wind and Fire",
